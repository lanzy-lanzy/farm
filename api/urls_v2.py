...
urlpatterns = [
    ...
    path("portal/sync-state/", PortalSyncStateView.as_view(), name="api-v2-portal-sync-state"),
    ...
    path("internal/options/", InternalOptionsView.as_view(), name="api-v2-internal-options"),
